...
**Kuna's Beauty Salon** (`https://kushysbeautyhaven.com` — also
...
| custom-domain  | https://kushysbeautyhaven.com                               | no (warn-only)  |

Both targets are **warn-only** today (2026-05-22) because:

1. DNS for `kushysbeautyhaven.com` still resolves to the legacy ELB
